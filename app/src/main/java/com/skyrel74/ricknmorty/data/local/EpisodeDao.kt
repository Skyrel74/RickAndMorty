...
interface EpisodeDao {
    ...
    @Query("SELECT * FROM episode_table WHERE name LIKE '%' || :query || '%' OR episode LIKE '%' || :query || '%' ")
    fun getAll(query: String): Observable<List<Episode>>
    ...
    @Query("SELECT COUNT(id) FROM episode_table WHERE name LIKE '%' || :query || '%' OR episode LIKE '%' || :query || '%' ")
    fun getCount(query: String): Observable<Int>
